...
public class ServerLoadBalancerTest {
	...
	public void balancingServerWithNotEnoughRoom_shouldNotBeFilledWithTheVm(){
		...
		balancing(aServersListWith(theServer), aVmsListWith(theVm));
		assertThat("server should not contain the second vm", !theServer.contains(theVm));
	}
	...
	public void balancingServerAndVms(){
		...
		assertThat("serer1 should contain the vm1", server1.contains(vm1));
		assertThat("serer2 should contain the vm2", server2.contains(vm2));
		assertThat("serer1 should contain the vm3", server1.contains(vm3));
